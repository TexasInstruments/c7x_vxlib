...
VXLIB_convolve_9x9_exec_ci(VXLIB_kernelHandle handle, void *restrict pIn, void *restrict pFilter, void *restrict pOut)
{
   ...
   c7x::short_vec vCoeff0_lo, vCoeff1_lo, vCoeff2_lo, vCoeff3_lo, vCoeff4_lo, vCoeff5_lo, vCoeff6_lo, vCoeff7_lo,
       vCoeff8_lo;
   c7x::short_vec vCoeff0_hi, vCoeff1_hi, vCoeff2_hi, vCoeff3_hi, vCoeff4_hi, vCoeff5_hi, vCoeff6_hi, vCoeff7_hi,
       vCoeff8_hi;
