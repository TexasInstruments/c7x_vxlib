...
#define VXLIB_TABLELOOKUP_I8U_I8U_O8U                                                                                  \
   ((dTypeIn == VXLIB_UINT8) && (dTypeOut == VXLIB_UINT8) && (dTypeLut == VXLIB_UINT8))
...
#define VXLIB_TABLELOOKUP_I16U_I16U_O16U                                                                               \
   ((dTypeIn == VXLIB_UINT16) && (dTypeOut == VXLIB_UINT16) && (dTypeLut == VXLIB_UINT16))
#define VXLIB_TABLELOOKUP_I16S_I16S_O16S                                                                               \
   ((dTypeIn == VXLIB_INT16) && (dTypeOut == VXLIB_INT16) && (dTypeLut == VXLIB_INT16))
/**
